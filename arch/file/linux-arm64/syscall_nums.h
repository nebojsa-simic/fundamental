#ifndef FUNDAMENTAL_FILE_SYSCALL_NUMS_LINUX_ARM64_H
#define FUNDAMENTAL_FILE_SYSCALL_NUMS_LINUX_ARM64_H

/*
 * Fundamental Library - Linux ARM64 Syscall Numbers
 * 
 * Zero-libc syscall number definitions for ARM64 (AArch64) Linux.
 ...
 * Note: ARM64 uses the "unified" syscall table (different from x86_64)
 */
 ...
 * Page Size
 * ============================================================================ */
/* ARM64 supports multiple page sizes: 4KB, 16KB, 64KB */
...
#endif /* FUNDAMENTAL_FILE_SYSCALL_NUMS_LINUX_ARM64_H */
