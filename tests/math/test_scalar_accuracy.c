...
typedef struct { const char *name; ScalarFn fn; float rel_tol; } ScalarTest;
...
TestCount test_scalar_accuracy(void)
{
    ...
    tc = run_1d_test("exp", fun_math_exp, exp_cases, sizeof(exp_case),
                      1e-3f);
    ...
    tc = run_1d_test("log", fun_math_log, log_cases, sizeof(log_case),
                      1e-3f);
    ...
    tc = run_1d_test("sin", fun_math_sin, sin_cases, sizeof(sin_case),
                      1e-3f);
    ...
    tc = run_1d_test("cos", fun_math_cos, cos_cases, sizeof(cos_case),
                      1e-3f);
    ...
    tc = run_1d_test("silu", fun_math_silu, silu_cases,
                      sizeof(silu_case), 1e-3f);
